...
const HistoricalData = ({ historicalData, dispatch }) => {
    ...
    const labels = data ? data.map(x => new Date(x.time * 1000).toISOString().slice(0,10)) : null;
    console.log(values);
    return (
        <Fragment>
            <div className="row">
                        ...
                        {loadingData && data ?
                            ...
                            <Fragment>
                                ...
                                <div className="panel-body">
                                    <ConfigurableChart defalutValue={true} startLine={2} endLine={3} data={{ labels: labels, data: values }} />
                                </div>
                            </Fragment>
                        }
                    </div>
